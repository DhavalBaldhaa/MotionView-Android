package com.dhavalbaldha.motionview.entity;
...
import com.dhavalbaldha.motionview.utils.MathUtils;
...
public abstract class MotionEntity {
    ...
    public boolean pointInLayerRect(PointF point) {
        ...
        return MathUtils.INSTANCE.pointInTriangle(point, pA, pB, pC) || MathUtils.INSTANCE.pointInTriangle(point, pA, pD, pC);
    }
